...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    public MenuListAdapter(Context mContext,List<Food> menuList,MenuListClickListener clickListener) {
        this.mContext = mContext;
        this.menuList = menuList;
        this.clickListener = clickListener;
    }

    public void setData(List<Food> menuList) {
        this.menuList = menuList;
    ...
    public void onBindViewHolder(@NonNull MenuListAdapter.MyViewHolder holder, int position) {
        ...
        holder.menuPrice.setText("Giá: "+menuList.get(position).getPrice()+"đ");
